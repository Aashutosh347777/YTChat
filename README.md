...
```ascii
                  ...
                  | Parallel<question,original_question,chat_history>Input |                  
       ...
       +--------------------+                   *                            *                
        ...
        | StrOutputParser |                | Lambda |                 | Passthrough |         
        ...
        +-----------------+****            +--------+            *****+-------------+         
                   ...
                   | Parallel<question,original_question,chat_history>Output |                
  ...
  +--------------------------+                            *                            *      
     ...
     +---------------------+                              *                            *      
       ...
       +-----------------+***                        +--------+         *******   +--------+  
                       ...
                       | Parallel<context,question,chat_history>Output |                      
...
## Demonstration Link
Demo of the system's working: <br>
[![Demo Video Thumbnail](https://placehold.co/600x350/007AFF/ffffff?text=Click+to+Watch+Demo+Video)](https://www.youtube.com/watch?v=f_bHXRuZki8)